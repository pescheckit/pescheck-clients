...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.V2ProfileUpdate();
  });
  ...
  describe('V2ProfileUpdate', function() {
    it('should create an instance of V2ProfileUpdate', function() {
      // uncomment below and update the code to test V2ProfileUpdate
      //var instance = new PescheckApi.V2ProfileUpdate();
      //expect(instance).to.be.a(PescheckApi.V2ProfileUpdate);
    });
