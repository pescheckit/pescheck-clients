...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.V2ProfileUpdateCheck();
  });
  ...
  describe('V2ProfileUpdateCheck', function() {
    it('should create an instance of V2ProfileUpdateCheck', function() {
      // uncomment below and update the code to test V2ProfileUpdateCheck
      //var instance = new PescheckApi.V2ProfileUpdateCheck();
      //expect(instance).to.be.a(PescheckApi.V2ProfileUpdateCheck);
    });
