...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.V2ScreeningCreate();
  });
  ...
  describe('V2ScreeningCreate', function() {
    it('should create an instance of V2ScreeningCreate', function() {
      // uncomment below and update the code to test V2ScreeningCreate
      //var instance = new PescheckApi.V2ScreeningCreate();
      //expect(instance).to.be.a(PescheckApi.V2ScreeningCreate);
    });
