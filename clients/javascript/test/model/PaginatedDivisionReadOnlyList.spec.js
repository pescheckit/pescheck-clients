...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.PaginatedDivisionReadOnlyList();
  });
  ...
  describe('PaginatedDivisionReadOnlyList', function() {
    it('should create an instance of PaginatedDivisionReadOnlyList', function() {
      // uncomment below and update the code to test PaginatedDivisionReadOnlyList
      //var instance = new PescheckApi.PaginatedDivisionReadOnlyList();
      //expect(instance).to.be.a(PescheckApi.PaginatedDivisionReadOnlyList);
    });
