...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.V2ScreeningDetailProfile();
  });
  ...
  describe('V2ScreeningDetailProfile', function() {
    it('should create an instance of V2ScreeningDetailProfile', function() {
      // uncomment below and update the code to test V2ScreeningDetailProfile
      //var instance = new PescheckApi.V2ScreeningDetailProfile();
      //expect(instance).to.be.a(PescheckApi.V2ScreeningDetailProfile);
    });
