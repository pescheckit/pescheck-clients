...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.PaginatedV2ScreeningListItemList();
  });
  ...
  describe('PaginatedV2ScreeningListItemList', function() {
    it('should create an instance of PaginatedV2ScreeningListItemList', function() {
      // uncomment below and update the code to test PaginatedV2ScreeningListItemList
      //var instance = new PescheckApi.PaginatedV2ScreeningListItemList();
      //expect(instance).to.be.a(PescheckApi.PaginatedV2ScreeningListItemList);
    });
