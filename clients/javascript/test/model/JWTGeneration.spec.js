...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.JWTGeneration();
  });
  ...
  describe('JWTGeneration', function() {
    it('should create an instance of JWTGeneration', function() {
      // uncomment below and update the code to test JWTGeneration
      //var instance = new PescheckApi.JWTGeneration();
      //expect(instance).to.be.a(PescheckApi.JWTGeneration);
    });
