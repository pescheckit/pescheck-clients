...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PescheckApi.V2Money();
  });
  ...
  describe('V2Money', function() {
    it('should create an instance of V2Money', function() {
      // uncomment below and update the code to test V2Money
      //var instance = new PescheckApi.V2Money();
      //expect(instance).to.be.a(PescheckApi.V2Money);
    });
