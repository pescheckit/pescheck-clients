...
namespace Pescheck.Client.Model
{
    ...
    /// V2ProfileCheckEntry
    /// </summary>
    [DataContract(Name = "V2ProfileCheckEntry")]
    public partial class V2ProfileCheckEntry : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ProfileCheckEntry" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets ConfiguredPrice
        /// </summary>
        [DataMember(Name = "configured_price", IsRequired = true, EmitDefaultValue = true)]
        public V2Money ConfiguredPrice { get; private set; }

        /// <summary>
        /// Returns false as ConfiguredPrice should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeConfiguredPrice()
        {
            return false;
        }
        /// <summary>
        ...
        public List<Object> InputFields { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConfiguredPrice: ").Append(ConfiguredPrice).Append("\n");
