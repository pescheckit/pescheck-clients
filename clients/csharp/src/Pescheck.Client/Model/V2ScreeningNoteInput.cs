...
namespace Pescheck.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V2ScreeningNoteInput")]
    public partial class V2ScreeningNoteInput : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScreeningNoteInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2ScreeningNoteInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScreeningNoteInput" /> class.
        /// </summary>
        ...
        public V2ScreeningNoteInput(string note = default, Guid? profileCheckId = default, CheckTypeEnum? checkType = default)
        {
            ...
            if (note == null)
            {
                throw new ArgumentNullException("note is a required property for V2ScreeningNoteInput and cannot be null");
            }
            this.Note = note;
        ...
        /// </summary>
        /// <value>Links the note to the Check spawned from this ProfileCheck. Wins over check_type.</value>
