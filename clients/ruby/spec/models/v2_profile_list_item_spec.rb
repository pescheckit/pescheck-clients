...
# Unit tests for Pescheck::V2ProfileListItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::V2ProfileListItem do
  #let(:instance) { Pescheck::V2ProfileListItem.new }

  describe 'test an instance of V2ProfileListItem' do
    it 'should create an instance of V2ProfileListItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::V2ProfileListItem)
    end
  end
  ...
  describe 'test attribute "check_types"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
