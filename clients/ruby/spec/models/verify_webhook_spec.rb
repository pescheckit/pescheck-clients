...
# Unit tests for Pescheck::VerifyWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::VerifyWebhook do
  #let(:instance) { Pescheck::VerifyWebhook.new }

  describe 'test an instance of VerifyWebhook' do
    it 'should create an instance of VerifyWebhook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::VerifyWebhook)
    end
  end
