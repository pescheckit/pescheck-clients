...
# Unit tests for Pescheck::V2ScreeningCheckEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::V2ScreeningCheckEntry do
  #let(:instance) { Pescheck::V2ScreeningCheckEntry.new }

  describe 'test an instance of V2ScreeningCheckEntry' do
    it 'should create an instance of V2ScreeningCheckEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::V2ScreeningCheckEntry)
    end
  end
