...
# Unit tests for Pescheck::V2ProfileCheckEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::V2ProfileCheckEntry do
  #let(:instance) { Pescheck::V2ProfileCheckEntry.new }

  describe 'test an instance of V2ProfileCheckEntry' do
    it 'should create an instance of V2ProfileCheckEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::V2ProfileCheckEntry)
    end
  end
  ...
  describe 'test attribute "configured_price"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
