...
# Unit tests for Pescheck::TokenRefresh
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::TokenRefresh do
  #let(:instance) { Pescheck::TokenRefresh.new }

  describe 'test an instance of TokenRefresh' do
    it 'should create an instance of TokenRefresh' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::TokenRefresh)
    end
  end
