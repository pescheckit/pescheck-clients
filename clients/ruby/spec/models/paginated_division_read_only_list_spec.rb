...
# Unit tests for Pescheck::PaginatedDivisionReadOnlyList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::PaginatedDivisionReadOnlyList do
  #let(:instance) { Pescheck::PaginatedDivisionReadOnlyList.new }

  describe 'test an instance of PaginatedDivisionReadOnlyList' do
    it 'should create an instance of PaginatedDivisionReadOnlyList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::PaginatedDivisionReadOnlyList)
    end
  end
