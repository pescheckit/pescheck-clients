...
# Unit tests for Pescheck::V2ProfileCheck
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pescheck::V2ProfileCheck do
  #let(:instance) { Pescheck::V2ProfileCheck.new }

  describe 'test an instance of V2ProfileCheck' do
    it 'should create an instance of V2ProfileCheck' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pescheck::V2ProfileCheck)
    end
  end
