...
/**
 * V2ScreeningCheckListItem Class Doc Comment
 *
 * @category Class
 * @description Minimal check entry shape for screening list items. No config/input/etc.
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V2ScreeningCheckListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ScreeningCheckListItem';
