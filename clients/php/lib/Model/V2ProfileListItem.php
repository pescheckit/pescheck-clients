...
/**
 * V2ProfileListItem Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2ProfileListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ProfileListItem';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('check_types', $data ?? [], null);
    ...
    {
        return $this->container['check_types'];
    }
     ...
     * @return self
     */
    public function setCheckTypes($check_types)
    {
        if (is_null($check_types)) {
            throw new \InvalidArgumentException('non-nullable check_types cannot be null');
        }
        $this->container['check_types'] = $check_types;
