...
/**
 * V2ScreeningCheck Class Doc Comment
 *
 * @category Class
 ...
 */
class V2ScreeningCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ScreeningCheck';
     ...
     *
     * @param string|null $profile_check_id Disambiguator. Use when the profile has multiple ProfileChecks of the same check_type.
     *
     * @return self
     */
