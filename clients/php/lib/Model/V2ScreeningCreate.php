...
/**
 * V2ScreeningCreate Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2ScreeningCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ScreeningCreate';
     ...
     * Gets checks
     *
     * @return \Pescheck\Client\Model\V2ScreeningCheck[]|null
     */
     ...
     * Sets checks
     *
     * @param \Pescheck\Client\Model\V2ScreeningCheck[]|null $checks checks
     *
     * @return self
     */
