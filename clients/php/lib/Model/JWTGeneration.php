...
/**
 * JWTGeneration Class Doc Comment
 *
 * @category Class
 ...
 */
class JWTGeneration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'JWTGeneration';
     ...
     * Sets email
     *
     * @param string $email Email address of the API user
     *
     * @return self
     */
     ...
     *
     * @param string|null $organisation_id Organization ID to generate token for
     *
     * @return self
     */
     ...
     * Sets division_id
     *
     * @param string|null $division_id Division ID to generate token for (optional)
     *
     * @return self
     */
