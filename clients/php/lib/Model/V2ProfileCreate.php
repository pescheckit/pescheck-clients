...
/**
 * V2ProfileCreate Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2ProfileCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ProfileCreate';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'checks' => '\Pescheck\Client\Model\V2ProfileCheck[]'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V2ProfileCreate., must be smaller than or equal to 255.');
        }
     ...
     * Gets checks
     *
     * @return \Pescheck\Client\Model\V2ProfileCheck[]
     */
     ...
     * Sets checks
     *
     * @param \Pescheck\Client\Model\V2ProfileCheck[] $checks checks
     *
     * @return self
     */
