...
/**
 * V2ScreeningNote Class Doc Comment
 *
 * @category Class
 ...
 */
class V2ScreeningNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ScreeningNote';
