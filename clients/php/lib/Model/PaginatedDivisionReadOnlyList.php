...
/**
 * PaginatedDivisionReadOnlyList Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedDivisionReadOnlyList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedDivisionReadOnlyList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\Pescheck\Client\Model\DivisionReadOnly[]'
    ];
     ...
     * Sets results
     *
     * @param \Pescheck\Client\Model\DivisionReadOnly[] $results results
     *
     * @return self
     */
