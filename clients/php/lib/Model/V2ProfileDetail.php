...
/**
 * V2ProfileDetail Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2ProfileDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ProfileDetail';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'is_custom' => 'bool',
        'checks' => '\Pescheck\Client\Model\V2ProfileCheckEntry[]',
        'total_price' => '\Pescheck\Client\Model\V2Money',
