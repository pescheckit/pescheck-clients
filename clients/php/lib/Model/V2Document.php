 ...
 */
class V2Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2Document';
    ...
    protected static $openAPITypes = [
        ...
        'filename' => 'string',
        'extension' => 'string',
        'content' => '\Pescheck\Client\Model\V2DocumentContent',
     ...
     * Sets check_id
     *
     * @param string|null $check_id check_id
     *
     * @return self
     */
    ...
    {
        if (is_null($check_id)) {
            array_push($this->openAPINullablesSetToNull, 'check_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('check_id', $nullablesSetToNull);
            if ($index !== FALSE) {
