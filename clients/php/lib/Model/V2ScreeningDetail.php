...
/**
 * V2ScreeningDetail Class Doc Comment
 *
 * @category Class
 * @package  Pescheck\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2ScreeningDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ScreeningDetail';
     ...
     *
     * @param string|null $candidate_wizard_url Public wizard URL for the candidate. Null when no check needs candidate input.
     *
     * @return self
     */
