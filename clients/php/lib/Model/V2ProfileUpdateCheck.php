...
/**
 * V2ProfileUpdateCheck Class Doc Comment
 *
 * @category Class
 ...
 */
class V2ProfileUpdateCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'V2ProfileUpdateCheck';
    ...
    public function setProfileCheckId($profile_check_id)
    {
        if (is_null($profile_check_id)) {
            throw new \InvalidArgumentException('non-nullable profile_check_id cannot be null');
        }
