...
public class JWTResponse {
  ...
  public JWTResponse refreshToken(@javax.annotation.Nonnull String refreshToken) {
  ...
  public JWTResponse expiresIn(@javax.annotation.Nonnull Integer expiresIn) {
  ...
  public JWTResponse organisation(@javax.annotation.Nonnull String organisation) {
  ...
  public JWTResponse organisationId(@javax.annotation.Nonnull UUID organisationId) {
  ...
  public void setOrganisationId(@javax.annotation.Nonnull UUID organisationId) {
    this.organisationId = organisationId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, jwTResponse.accessToken) &&
        ...
        Objects.equals(this.expiresIn, jwTResponse.expiresIn) &&
        Objects.equals(this.organisation, jwTResponse.organisation) &&
        Objects.equals(this.organisationId, jwTResponse.organisationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, refreshToken, tokenType, expiresIn, organisation, organisationId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_token", "refresh_token", "token_type", "expires_in", "organisation", "organisation_id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access_token", "refresh_token", "expires_in", "organisation", "organisation_id"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JWTResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in JWTResponse is not found in the empty JSON string", JWTResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JWTResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `JWTResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
