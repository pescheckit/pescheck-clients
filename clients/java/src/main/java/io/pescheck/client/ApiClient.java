...
import io.pescheck.client.auth.Authentication;
import io.pescheck.client.auth.HttpBasicAuth;
import io.pescheck.client.auth.HttpBearerAuth;
import io.pescheck.client.auth.ApiKeyAuth;
import io.pescheck.client.auth.OAuth;
import io.pescheck.client.auth.RetryingOAuth;
import io.pescheck.client.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pescheck.io)
     ...
     * @return a {@link io.pescheck.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.pescheck.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.pescheck.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.pescheck.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.pescheck.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.pescheck.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.pescheck.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.pescheck.client.ApiException If fails to update the parameters
     */
     ...
     * @throws io.pescheck.client.ApiException If fail to serialize the request body object into a string
     */
