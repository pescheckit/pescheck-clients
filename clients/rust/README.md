...
Put the package under your project folder in a directory named `pescheck` and add the following to `Cargo.toml` under `[dependencies]`:

```
pescheck = { path = "./pescheck" }
```
