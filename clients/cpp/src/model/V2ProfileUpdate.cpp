...
void V2ProfileUpdate::validate()
{
    // TODO: implement validation
}

web::json::value V2ProfileUpdate::toJson() const
{
...
bool V2ProfileUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("checks"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V2ProfileUpdateCheck>> refVal_setChecks;
...
void V2ProfileUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V2ProfileUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t V2ProfileUpdate::getName() const
{
    return m_Name;
}


void V2ProfileUpdate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V2ProfileUpdate::nameIsSet() const
{
    return m_NameIsSet;
}

void V2ProfileUpdate::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V2ProfileUpdate::getDescription() const
{
    return m_Description;
}


void V2ProfileUpdate::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool V2ProfileUpdate::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void V2ProfileUpdate::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::vector<std::shared_ptr<V2ProfileUpdateCheck>> V2ProfileUpdate::getChecks() const
{
    return m_Checks;
}


void V2ProfileUpdate::setChecks(const std::vector<std::shared_ptr<V2ProfileUpdateCheck>>& value)
{
    m_Checks = value;
    m_ChecksIsSet = true;
}

bool V2ProfileUpdate::checksIsSet() const
{
    return m_ChecksIsSet;
}

void V2ProfileUpdate::unsetChecks()
{
    m_ChecksIsSet = false;
}
