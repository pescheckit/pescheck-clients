...
// APIClient manages communication with the Pescheck API API v2.0.0
...
type APIClient struct {
	...
	DivisionsAPI *DivisionsAPIService

	OAuthAPI *OAuthAPIService

	ProfilesAPI *ProfilesAPIService

	ScreeningsAPI *ScreeningsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ScreeningsAPI = (*ScreeningsAPIService)(&c.common)
