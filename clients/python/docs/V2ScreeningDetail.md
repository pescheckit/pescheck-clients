...
**candidate_wizard_url** | **str** | Public wizard URL for the candidate. Null when no check needs candidate input. | [optional] [readonly] 
**dashboard_url** | **str** | Dashboard URL for this screening. | [optional] [readonly] 
