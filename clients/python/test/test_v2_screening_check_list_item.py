...
class TestV2ScreeningCheckListItem(unittest.TestCase):
    """V2ScreeningCheckListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ScreeningCheckListItem:
        """Test V2ScreeningCheckListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ScreeningCheckListItem`
        """
        model = V2ScreeningCheckListItem()
        if include_optional:
            return V2ScreeningCheckListItem(
                id = '',
    ...
    def testV2ScreeningCheckListItem(self):
        """Test V2ScreeningCheckListItem"""
