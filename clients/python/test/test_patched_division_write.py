...
class TestPatchedDivisionWrite(unittest.TestCase):
    """PatchedDivisionWrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedDivisionWrite:
        """Test PatchedDivisionWrite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedDivisionWrite`
        """
        model = PatchedDivisionWrite()
        if include_optional:
            return PatchedDivisionWrite(
                id = '',
                name = '',
                city = '',
                address = '',
    ...
    def testPatchedDivisionWrite(self):
        """Test PatchedDivisionWrite"""
