...
class VerifyWebhook(BaseModel):
    ...
    """ # noqa: E501
    verification_code: StrictStr = Field(description="The verification code delivered to the webhook URL on creation.")
    __properties: ClassVar[List[str]] = ["verification_code"]
