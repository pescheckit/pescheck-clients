...
from pescheck.configuration import Configuration
from pescheck.api_response import ApiResponse, T as ApiResponseT
import pescheck.models
from pescheck import rest
from pescheck.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pescheck.models, klass)
